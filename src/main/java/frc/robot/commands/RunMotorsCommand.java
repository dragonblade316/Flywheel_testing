...
public class RunMotorsCommand extends CommandBase {
    ...
    public RunMotorsCommand(FlyWheelMotorsSubsystem subsystem, SendableChooser<Double> right, SendableChooser<Double> left) {
    ...
    public void initialize() {
        subsystem.set(right.getSelected(), left.getSelected());
    }
